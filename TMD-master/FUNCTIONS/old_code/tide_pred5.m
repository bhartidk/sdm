...
SDtime = [datenum(2016,1,1,0,0,0):datenum(0,0,0,1,0,0):datenum(2016,1,16,0,0,0)]';%time series from 1 Jan 2016 to 15 Jan 2016, every hour
type = 'z';
sc = [1:4]; %using the first four consituent harmonics
...
nccreate('tide_15days.nc', 'tidal_range_mean', 'Dimensions', { 'x', 1230, 'y', 1513} );
ncwrite(    'tide_15days.nc', 'tidal_range_mean', tidal_range_mean);
ncwriteatt( 'tide_15days.nc', 'tidal_range_mean', 'long_name', 'mean tidal range between 1-15 Jan 2016' );
ncwriteatt( 'tide_15days.nc', 'tidal_range_mean', 'units', 'm' );

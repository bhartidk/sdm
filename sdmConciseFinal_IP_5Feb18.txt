#kfold prediction SD
#pseudoabsences a certain distance away from presence sites
#MESS map
#limiting variable

setwd("C:/Bharti/PhD data/Analysis/Chapter2_2Nov17")

#randomBg, bufHabBg, bufBg - do not have 10000 points - lesser number of points than that. 
...
ip.occ<-read.csv("dataframes/ip_occ_15Feb18.csv")
head(ip.occ)
colnames(ip.occ)
...
ind.occ[[i]]<-subset(ip.occ, ip.occ$species %in% sp[i])
...
#rs<-c("rocky", "mixed")
#mg<-c("mangrove", "mixed")
#str.occ<-str.occ[str.occ$habitat %in% rs,]
#str.occ<-str.occ[str.occ$habitat %in% mg,]

n<-"str.occ"
sp.occ<-ind.occ[[n]]
#sp.occ<-str.occ
sp_name<-"strigata_rocky_beta"
...
#checking if the correct raster has been loaded - in terms of extent
plot(predictors[[1]])
...
nrow(records)
nrow(recordsNoDups)
write.csv(recordsNoDups, file=paste0("results_ip/", sp_name, "/occ.csv"), row.names=FALSE)
...
jpeg(file=paste0("results_ip/", sp_name, "/hist.jpeg"),  height=10, width = 10, units = 'in', res=300)
...
randomBg<-read.csv("dataframes/randomBg_ip.csv")
kdBg<-read.csv("dataframes/kdBg_ip.csv")
kdRockBg<-read.csv("dataframes/kdRockBg_ip.csv")
#kdMangBg<-read.csv("dataframes/kdMangBg_ip.csv")
bufBg<-read.csv("dataframes/bufBg_ip.csv")
bufRockBg<-read.csv("dataframes/bufRockBg_ip.csv")
#bufMangBg<-read.csv("dataframes/bufMangBg_ip.csv")
...
write.csv(randomBgIn, file=paste0("results_ip/", sp_name, "/randomBg_input.csv"), row.names=FALSE)
...
write.csv(kdBgIn, file=paste0("results_ip/", sp_name, "/kdBg_input.csv"), row.names=FALSE)
...
write.csv(kdHabBgIn, file=paste0("results_ip/", sp_name, "/kdHabBg_input.csv"), row.names=FALSE)
...
write.csv(bufBgIn, file=paste0("results_ip/", sp_name, "/bufBg_input.csv"), row.names=FALSE)
...
write.csv(bufHabBgIn, file=paste0("results_ip/", sp_name, "/bufHabBg_input.csv"), row.names=FALSE)
...
sink(paste0("results_ip/", sp_name, "/AIC.txt"))
...
jpeg(file=paste0("results_ip/", sp_name, "/randomBgvarImp.jpeg"), height=10, width = 10, units = 'in', res=300)
plot(randomBgModel)
dev.off()

write.csv(randomBgModel@results, paste0("results_ip/", sp_name, "/randomBgModel.csv"))

save(randomBgModel, file=paste0("results_ip/", sp_name, "/randomBgModel"))

jpeg(file=paste0("results_ip/", sp_name, "/randomBgResponse.jpeg") ,  height=10, width = 10, units = 'in', res=300)
response(randomBgModel, range='p')
dev.off()

randomBgMap<-predict(randomBgModel, predictors)
writeRaster(randomBgMap, filename=paste0("results_ip/", sp_name, "/randomBgMap"), format="GTiff", overwrite=TRUE)
...
write.csv(kdBgModel@results, paste0("results_ip/", sp_name, "/kdBgModel.csv"))

jpeg(file=paste0("results_ip/", sp_name, "/kdBgvarImp.jpeg"),  height=10, width = 10, units = 'in', res=300)
plot(kdBgModel)
dev.off()

save(kdBgModel, file=paste0("results_ip/", sp_name, "/kdBgModel"))

jpeg(file=paste0("results_ip/", sp_name, "/kdBgResponse.jpeg"),  height=10, width = 10, units = 'in', res=300)
response(kdBgModel, range='p')
dev.off()

kdBgMap<-predict(kdBgModel, predictors)
writeRaster(kdBgMap, filename=paste0("results_ip/", sp_name, "/kdBgMap"), format="GTiff", overwrite=TRUE)

##Maxent model using kernel density based points - but for habitat specific background sites only
kdHabBgModel<-maxent(x=kdHabBgIn[,3:(ncol(kdHabBgIn)-1)], p=kdHabBgIn[,ncol(kdHabBgIn)], args=c('linear=true', 'quadratic=true', 'product=true',
'threshold=false', 'hinge=false',  paste0("betamultiplier=", kdHabBg_beta)))

write.csv(kdHabBgModel@results, paste0("results_ip/", sp_name, "/kdHabBgModel.csv"))

jpeg(file=paste0("results_ip/", sp_name, "/kdHabBgvarImp.jpeg"),  height=10, width = 10, units = 'in', res=300)
plot(kdHabBgModel)
dev.off()

save(kdHabBgModel, file=paste0("results_ip/", sp_name, "/kdHabBgModel"))

jpeg(file=paste0("results_ip/", sp_name, "/kdHabBgResponse.jpeg"),  height=10, width = 10, units = 'in', res=300)
response(kdHabBgModel, range='p')
dev.off()

kdHabBgMap<-predict(kdHabBgModel, predictors)
writeRaster(kdHabBgMap, filename=paste0("results_ip/", sp_name, "/kdHabBgMap"), format="GTiff", overwrite=TRUE)
...
jpeg(file=paste0("results_ip/", sp_name, "/bufBgvarImp.jpeg"),  height=10, width = 10, units = 'in', res=300)
plot(bufBgModel)
dev.off()

write.csv(bufBgModel@results, paste0("results_ip/", sp_name, "/bufBgModel.csv"))
save(bufBgModel, file=paste0("results_ip/", sp_name, "/bufBgModel"))

jpeg(file=paste0("results_ip/", sp_name, "/bufBgResponse.jpeg"), height=10, width = 10, units = 'in', res=300)
response(bufBgModel, range='p')
dev.off()

bufBgMap<-predict(bufBgModel, predictors)

writeRaster(bufBgMap, filename=paste0("results_ip/", sp_name, "/bufBgMap"), format="GTiff", overwrite=TRUE)
...
write.csv(bufHabBgModel@results, paste0("results_ip/", sp_name, "/bufHabBgModel.csv"))

jpeg(file=paste0("results_ip/", sp_name, "/bufHabBgvarImp.jpeg"),  height=10, width = 10, units = 'in', res=300)
plot(bufHabBgModel)
dev.off()

save(bufHabBgModel, file=paste0("results_ip/", sp_name, "/bufHabBgModel"))

jpeg(file=paste0("results_ip/", sp_name, "/bufHabBgResponse.jpeg"), height=10, width = 10, units = 'in', res=300)
bufHabBgResponse<-response(bufHabBgModel, range='p')
dev.off()

bufHabBgMap<-predict(bufHabBgModel, predictors)
writeRaster(bufHabBgMap, filename=paste0("results_ip/", sp_name, "/bufHabBgMap"), format="GTiff", overwrite=TRUE)
...
jpeg(file = paste0("results_ip/", sp_name,"/", names(mod.input)[j], "JK.jpeg"),  height=10, width = 10, units = 'in', res=300)
...
jpeg(file=paste0("results_ip/", sp_name, "/randomBgROC.jpeg"),  height=10, width = 10, units = 'in', res=300)
plot(randomBgEval, 'ROC')
dev.off()
jpeg(file=paste0("results_ip/", sp_name, "/randomBgDens.jpeg"),  height=10, width = 20, units = 'in', res=300)
par(mfrow=c(1,2))
boxplot(randomBgEval)
density(randomBgEval)
dev.off()
save(randomBgEval, file=paste0("results_ip/", sp_name, "/randomBgEval"))

kdBgEval<-evaluate(p=recordsNoDups[,3:ncol(recordsNoDups)], a=kdBg[,3:ncol(kdBg)], kdBgModel)
jpeg(file=paste0("results_ip/", sp_name, "/kdBgROC.jpeg"),  height=10, width = 10, units = 'in', res=300)
plot(kdBgEval, 'ROC')
dev.off()
jpeg(file=paste0("results_ip/", sp_name, "/kdBgDens.jpeg"),  height=10, width = 20, units = 'in', res=300)
par(mfrow=c(1,2))
boxplot(kdBgEval, notch=FALSE)
density(kdBgEval)
dev.off()
save(kdBgEval, file=paste0("results_ip/", sp_name, "/kdBgEval"))

kdHabBgEval<-evaluate(p=recordsNoDups[,3:ncol(recordsNoDups)], a=kdHabBg[,3:ncol(kdHabBg)], kdHabBgModel)
jpeg(file=paste0("results_ip/", sp_name, "/kdHabBgROC.jpeg"),  height=10, width = 10, units = 'in', res=300)
plot(kdHabBgEval, 'ROC')
dev.off()
jpeg(file=paste0("results_ip/", sp_name, "/kdHabBgDens.jpeg"),  height=10, width = 20, units = 'in', res=300)
par(mfrow=c(1,2))
boxplot(kdHabBgEval, notch=FALSE)
density(kdHabBgEval)
dev.off()
save(kdHabBgEval, file=paste0("results_ip/", sp_name, "/kdHabBgEval"))

bufBgEval<-evaluate(p=recordsNoDups[,3:ncol(recordsNoDups)], a=bufBg[,3:ncol(bufBg)], bufBgModel)
jpeg(file=paste0("results_ip/", sp_name, "/bufBgROC.jpeg"),  height=10, width = 10, units = 'in', res=300)
plot(bufBgEval, 'ROC')
dev.off()
jpeg(file=paste0("results_ip/", sp_name, "/bufBgDens.jpeg"),  height=10, width = 20, units = 'in', res=300)
par(mfrow=c(1,2))
boxplot(bufBgEval, notch=FALSE)
density(bufBgEval)
dev.off()
save(bufBgEval, file=paste0("results_ip/", sp_name, "/bufBgEval"))

bufHabBgEval<-evaluate(p=recordsNoDups[,3:ncol(recordsNoDups)], a=bufHabBg[,3:ncol(bufHabBg)], bufHabBgModel)
jpeg(file=paste0("results_ip/", sp_name, "/bufHabBgROC.jpeg"),  height=10, width = 10, units = 'in', res=300)
plot(bufHabBgEval, 'ROC')
dev.off()
jpeg(file=paste0("results_ip/", sp_name, "/bufHabBgDens.jpeg"),  height=10, width = 20, units = 'in', res=300)
par(mfrow=c(1,2))
boxplot(bufHabBgEval, notch=FALSE)
density(bufHabBgEval)
dev.off()
save(bufHabBgEval, file=paste0("results_ip/", sp_name, "/bufHabBgEval"))
...
sink(paste0("results_ip/", sp_name, "/kfold.txt"))
cat(sprintf("randomBg\n"))
print(randomBgKfold)
cat(sprintf("kdBg\n"))
print(kdBgKfold)
...
jpeg(file = paste0("results_ip/", sp_name, "/", names(modelMap)[i], "Res.jpeg"),  height=10, width = 10, units = 'in', res=300)
...
#####################LIMITING FACTOR###########################
#creating a limiting variable map for the model - taking too much memory to run this, so skipping it
randomBgLim<-limiting(predictors, randomBgModel)
writeRaster(randomBgLim, filename=paste0("results_ip/", sp_name, "/randomBgLim"), format="GTiff", overwrite=TRUE)

#creating a limiting variable map for the model
kdBgLim<-limiting(predictors, kdBgModel)
writeRaster(kdBgLim, filename=paste0("results_ip/", sp_name, "/kdBgLim"), format="GTiff", overwrite=TRUE)

#creating a limiting variable map for the model
kdHabBgLim<-limiting(predictors, kdHabBgModel)
writeRaster(kdHabBgLim, filename=paste0("results_ip/", sp_name, "/kdHabBgLim"), format="GTiff", overwrite=TRUE)

#creating a limiting variable map for the model
bufBgLim<-limiting(predictors, bufBgModel)
writeRaster(bufBgLim, filename=paste0("results_ip/", sp_name, "/bufBgLim"), format="GTiff", overwrite=TRUE)

#creating a limiting variable map for the model
bufHabBgLim<-limiting(predictors, bufHabBgModel)
writeRaster(bufHabBgLim, filename=paste0("results_ip/", sp_name, "/bufHabBgLim"), format="GTiff", overwrite=TRUE)
###############################################################
#looking at the correlations between environmental variables only for species presence locations

##Indian Ocean domain
sp_names<-c("undulata", "bengalensis", "carinifera", "pallescens", "melanostoma", "malaccana", "leucosticta", "vidua", "omanensis")

hab_names<-c("mangrove", "rocky")

for (i in 1:length(sp_names)){
sp.var<-read.csv(paste0("results_ip/", sp_names[i], "/bufBg_input.csv"))
sp.var<-sp.var[sp.var$presentBg==1, 3:(ncol(sp.var)-1)]
cor.mat<-cor(sp.var, method = "spearman", use = "complete.obs")
cor.mat[upper.tri(cor.mat, diag=TRUE)]<-NA
write.csv(cor.mat, file=paste0("results_ip/", sp_names[i], "/presCorMatrix.csv"))
}

for (i in 1:length(hab_names)){
sp.var<-read.csv(paste0("results_ip/strigata/", hab_names[i], "/bufBg_input.csv"))
sp.var<-sp.var[sp.var$presentBg==1, 3:(ncol(sp.var)-1)]
cor.mat<-cor(sp.var, method = "spearman", use = "complete.obs")
cor.mat[upper.tri(cor.mat, diag=TRUE)]<-NA
write.csv(cor.mat, file=paste0("results_ip/strigata/", hab_names[i], "/presCorMatrix.csv"))
}